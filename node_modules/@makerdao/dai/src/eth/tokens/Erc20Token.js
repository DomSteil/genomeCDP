...
var Erc20Token = function () {
  ...
  (0, _createClass3.default)(Erc20Token, [{
    ...
    value: function approve(spender, value) {
      ...
      var _ref4$unit = _ref4.unit,
          unit = _ref4$unit === undefined ? this._currency : _ref4$unit,
          options = (0, _objectWithoutProperties3.default)(_ref4, ['unit']);

      return this._contract.approve(spender, this._valueForContract(value, unit), options || {});
    }
  }, {
    ...
    value: function transfer(to, value) {
      var _ref5 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
          ...
          unit = _ref5$unit === undefined ? _Currency.currencies[this.symbol] : _ref5$unit,
    ...
    value: function transferFrom(from, to, value) {
      var _ref6 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
          ...
          unit = _ref6$unit === undefined ? _Currency.currencies[this.symbol] : _ref6$unit,
          promise = _ref6.promise;

      return this._contract.transferFrom(from, to, this._valueForContract(value, unit), { promise: promise });
    }
  }]);
  return Erc20Token;
}();
