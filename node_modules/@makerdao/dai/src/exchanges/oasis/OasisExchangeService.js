        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                oasisContract = this.get('smartContract').getContractByName(_contracts2.default.MAKER_OTC);
              ...
              case 8:
                return _context.abrupt('return', _OasisOrder.OasisSellOrder.build(oasisContract, 'sellAllAmount', [daiAddress, daiAmountEVM, buyToken.address(), minFillAmountEVM], this.get('transactionManager'), currency));
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                return _context2.abrupt('return', _OasisOrder.OasisBuyOrder.build(oasisContract, 'buyAllAmount', [daiAddress, daiAmountEVM, sellTokenAddress, maxFillAmountEVM], this.get('transactionManager')));
